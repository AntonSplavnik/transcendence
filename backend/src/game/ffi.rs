...
mod tests {
    ...
    fn converts_state_change_event() {
        let raw = CNetworkEvent {
            tag: 3,
            payload: CNetworkEventPayload {
                state_change: CStateChangePayload {
                    player_id: 9,
                    state: 2,
                },
            },
