...
pub async fn accept_friend_request(
    ...
    let updated_request: FriendRequest = diesel::update(fr::friend_requests.filter(fr::id.eq(request_id)))
    ...
    json_ok(FriendRequestResponse::new(&updated_request, sender, receiver))
}
