					...
					<table className="w-full text-sm">
						...
						<thead>
							<tr className="bg-stone-800/60 text-stone-300 text-xs uppercase tracking-wider">
								...
								<th scope="col" className="px-3 py-2 text-left">Class</th>
								<th scope="col" className="px-3 py-2 text-right">Kills</th>
								<th scope="col" className="px-3 py-2 text-right">Deaths</th>
								<th scope="col" className="px-3 py-2 text-right">Dmg Dealt</th>
								<th scope="col" className="px-3 py-2 text-right">Dmg Taken</th>
							</tr>
						</thead>
						<tbody>
							{sorted.map((p) => {
