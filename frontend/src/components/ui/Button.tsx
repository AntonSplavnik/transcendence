...
const variantStyles = {
  ...
  danger:
    "bg-danger hover:bg-danger/90 text-white border-b-4 border-b-danger-dark active:border-b-0 active:translate-y-1 hover:shadow-[0_0_12px_rgba(200,32,48,0.25)]",
  ghost:
    "bg-transparent hover:bg-stone-800 text-stone-300 hover:text-stone-100",
};
...
export default function Button({
  ...
  return (
    <button
      ...
      {...props}
    >
      {loading && <LoadingSpinner size="sm" color={variant === "primary" ? "white" : "stone"} />}
