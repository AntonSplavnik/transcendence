...
const variantStyles: Record<string, string> = {
  error:
    "bg-danger-bg border-danger text-danger-light shadow-[inset_0_0_12px_rgba(200,32,48,0.08)]",
  warning:
    "bg-warning-bg border-warning text-warning-light shadow-[inset_0_0_12px_rgba(240,128,56,0.08)]",
  info:
    "bg-info-bg border-info text-info-light shadow-[inset_0_0_12px_rgba(64,144,224,0.08)]",
  success:
