...
// =============================================================================
// CollisionSystemEnTT - EnTT-based collision detection and resolution
// =============================================================================
...
class CollisionSystemEnTT : public SystemEnTT {
public:
    CollisionSystemEnTT() = default;

    // System interface
    void fixedUpdate(float fixedDeltaTime) override;
    const char* getName() const override { return "CollisionSystemEnTT"; }
...
inline void CollisionSystemEnTT::fixedUpdate(float fixedDeltaTime) {
...
inline bool CollisionSystemEnTT::checkCollision(
    const Components::Transform& transformA, const Components::Collider& colliderA,
    const Components::Transform& transformB, const Components::Collider& colliderB
) const {
...
inline void CollisionSystemEnTT::resolveCollision(
    Components::Transform& transformA, const Components::Collider& colliderA,
    Components::Transform& transformB, const Components::Collider& colliderB,
    const Components::PhysicsBody* physicsA, const Components::PhysicsBody* physicsB
) {
